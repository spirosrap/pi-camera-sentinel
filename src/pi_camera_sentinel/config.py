...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            poll_seconds=env_float("SENTINEL_POLL_SECONDS", 0.5, "MOTION_POLL_SECONDS"),
            cooldown_seconds=env_float("SENTINEL_COOLDOWN_SECONDS", 30.0, "MOTION_COOLDOWN_SECONDS"),
            diff_threshold=env_int("SENTINEL_DIFF_THRESHOLD", 25, "MOTION_DIFF_THRESHOLD"),
            changed_ratio=env_float("SENTINEL_CHANGED_RATIO", 0.008, "MOTION_CHANGED_RATIO"),
            min_motion_frames=env_int("SENTINEL_MIN_FRAMES", 2, "MOTION_MIN_FRAMES"),
            resize_width=env_int("SENTINEL_RESIZE_WIDTH", 320, "MOTION_RESIZE_WIDTH"),
            resize_height=env_int("SENTINEL_RESIZE_HEIGHT", 180, "MOTION_RESIZE_HEIGHT"),

...
install -m 0644 "${PROJECT_ROOT}/systemd/pi-camera-health-watchdog.service" /etc/systemd/system/pi-camera-health-watchdog.service
...
echo "  sudo systemctl enable --now pi-camera-health-watchdog.service"
